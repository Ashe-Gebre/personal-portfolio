        ...
        <nav className={`navbar navbar-expand-lg navbar-light ${mClass}`}>
          <div className={`container ${mContainer}`}>
            <a className="navbar-brand logo_h" href="./">
              <img style = {{width:"180px", height: "185px", borderRadius:"10px" }} src={require("../../image/" + mainlogo)} alt="" />
              <img style={{width:"86px", height: "75px", borderRadius:"10px" }}  src={require("../../image/" + stickylogo)} alt="" />
            </a>
            <a
              href="./"
