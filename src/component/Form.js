...
const URL = "https://mkeqhune73.execute-api.us-east-1.amazonaws.com/v1/contacts";
...
class Form extends React.Component {
  ...
  submitHandler = async (e) => {
    ...
    data.subject = this.state.errors.subject;
    data.content = this.state.errors.message;
    ...
    alert(`Thank you, ${data.name} for your message. I will contact you as soon as possible. Cheers!`)
